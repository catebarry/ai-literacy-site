      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-4 space-y-4">
          ...
          {/* <div className="border-t border-purple-200 pt-4"> */}
            <p className="text-lg font-semibold text-purple-900 mb-2">Why do hallucinations matter?</p>
          ...
          <div className="border-t border-purple-200 pt-4">
            <p className="text-lg font-bold text-purple-900 mb-4">What types of hallucinations exist?</p>
            <div className="space-y-4">
              <div>
                <p className="text-base font-semibold text-purple-900 mb-1">Factual inaccuracies</p>
              ...
              <div>
                <p className="text-base font-semibold text-purple-900 mb-1">Citation/source fabrication</p>
              ...
              <div>
                <p className="text-base font-semibold text-purple-900 mb-1">Self-contradiction</p>
              ...
              <div>
                <p className="text-base font-semibold text-purple-900 mb-1">Prompt-contradiction</p>
              ...
              <div>
                <p className="text-base font-semibold text-purple-900 mb-1">Visual distortion (images)</p>
              ...
              <div>
                <p className="text-base font-semibold text-purple-900 mb-1">Procedural/logical errors</p>
